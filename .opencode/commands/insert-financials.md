---
description: Generate a SQL REPLACE INTO file for the BusMgmtBenchmarks Dolt database from reconciled /analyze-financials output. Run AFTER /analyze-financials. Usage: /insert-financials TICKER YEAR
---
